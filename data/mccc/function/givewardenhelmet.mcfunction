...
scoreboard players set @a ltwardenrage 0
...
execute as @a[scores={health=..10}] if items entity @s armor.* minecraft:player_head[minecraft:custom_data={wardenhelmet:1b}] if items entity @s armor.* minecraft:leather_chestplate[minecraft:custom_data={wardenchestplate:1b}] if items entity @s armor.* minecraft:leather_leggings[minecraft:custom_data={wardenleggings:1b}] if items entity @s armor.* minecraft:leather_boots[minecraft:custom_data={wardenboots:1b}] run scoreboard players set @s ltwardenrage 1
execute as @a[scores={wardenrage=1,ltwardenrage=0}] at @s run say hi
